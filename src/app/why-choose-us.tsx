  ...
  return (
    <div className="flex gap-4">
      ...
      <div>
        ...
        <Typography placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} className="mb-2 md:w-10/12 font-normal !text-gray-500">
          {children}
        </Typography>
      </div>
    </div>
...
export function WhyChooseUs() {
  return (
    <section className="w-full max-w-4xl mx-auto flex flex-col items-center px-4 py-10">
      <Typography placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} variant="h2" className="text-center mb-2" color="blue-gray">
      ...
      <Typography placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}
        ...
        className="mb-16 w-full text-center font-normal !text-gray-500 lg:w-10/12"
      >
        O aplicativo oferece ao motorista acesso facilitado a cursos, atualização constante, reconhecimento por desempenho e total controle sobre sua carreira, promovendo crescimento profissional, mais oportunidades e segurança.
      </Typography>
      <div className="mt-8">
        <div className="grid grid-cols-1 items-center md:grid-cols-2 gap-12 mb-24">
          <div className="space-y-8">
            <div className="my-4">
              <Option icon={UserIcon} title="Capacitação Exclusiva">
                Tenha acesso a cursos e treinamentos diretamente pelo aplicativo, ampliando suas habilidades e aumentando suas oportunidades de trabalho.
              </Option>
            </div>
            <div className="mb-4 flex gap-4">
              <Option icon={BookOpenIcon} title="Atualização Constante">
                Mantenha-se sempre atualizado com conteúdos e reciclagens no app, garantindo destaque, segurança e competitividade no mercado.
              </Option>
            </div>
            <Option icon={StarIcon} title="Gestão e Reconhecimento">
              Acompanhe seu desempenho, conquiste reconhecimento e gerencie sua carreira de forma prática e transparente, tudo pelo aplicativo.
            </Option>
          </div>
